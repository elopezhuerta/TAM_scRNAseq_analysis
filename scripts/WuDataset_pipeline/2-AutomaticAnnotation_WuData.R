# ============================================================================
# Title: Automatic Cell Type Annotation with SingleR (Wu Dataset)
# Author: elopezhuerta
...
# --- Save integrated_seurat object ---
saveRDS(integrated_seurat, file = "results/seurat_objects/WuDataset/SnR.Annotated_Wu.rds")
