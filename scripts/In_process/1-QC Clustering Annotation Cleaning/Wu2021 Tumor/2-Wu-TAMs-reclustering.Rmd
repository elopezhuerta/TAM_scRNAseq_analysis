...
# Load Input Data
```{r}
#red_pal <- brewer.pal(9, "YlOrRd")
Annotated <- readRDS("results/seurat_objects/WuDataset/Refined_Annotated.rds")
...
Raw_WuDataset <- readRDS("data/objects/Wu_Seurat_V4.rds")
Raw_WuDataset@meta.data[, c("celltype_subset", "celltype_minor", "celltype_major")] <- NULL
